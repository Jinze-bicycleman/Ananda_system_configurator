  ...
  switch (productType) {
    ...
    case "hmi": {
      ...
      return [
        ...
        { label: "Support Level", value: fmt(d.support_level) },
        { label: "Holder Size", value: fmt(d.holder_mm) },
        { label: "Cable Length", value: fmt(d.cable_length_mm) },
        { label: "Mounting Position", value: fmt(d.mounting_position) },
        ...
        { label: "Certifications", value: fmt(d.certifications) },
    ...
    case "battery": {
      ...
      return [
        ...
        { label: "Capacity (Wh)", value: fmt(b.capacity_wh, "Wh") },
        { label: "Capacity (Ah)", value: fmt(b.capacity_ah, "Ah") },
