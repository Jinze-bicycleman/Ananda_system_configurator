...
export function Step1ProjectContext() {
  ...
  return <div className="space-y-4">
    ...
    <section id="field-sellRegion" className={cn("border border-border bg-card", open === 0 && "border-primary/50")}>
    ...
    <section id="field-regulation" className={cn("border border-border bg-card", open === 1 && "border-primary/50")}>
